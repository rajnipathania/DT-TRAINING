...
<div class="container-fluid">
 ...
 <h1>View Supplier</h1>
  <table border="1" width="100%">
     ...
     <td><a href="editS/${x.supplier_id}"><span class="glyphicon glyphicon-pencil"></span></a></td>
     <td><a href="deleteS/${x.supplier_id}"><span class="glyphicon glyphicon-trash"></span></a></td> 
     </tr>
     </c:forEach>
  </table>
</form>
